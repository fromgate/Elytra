...
public class ElytraCooldown {
    ...
    static void clearCoolDown (Player player, Type type){
        ...
        } else if (cooldowns.containsKey(player.getName()+"."+type.name())) cooldowns.remove(player.getName()+"."+type.name());
    }
    ...
    enum Type {
        ...
        public boolean isEnabled(){
            switch (this){
                case RUN_UP: return Elytra.getCfg().runUpCooldown;
                case SHIFT: return Elytra.getCfg().shiftCooldownEnable;
            }
        ...
        public long delay(){
            switch (this){
                case RUN_UP: return Time.parseTime(Elytra.getCfg().runUpCooldownTime);
                case SHIFT: return Time.parseTime(Elytra.getCfg().shiftCooldownTime);
            }
